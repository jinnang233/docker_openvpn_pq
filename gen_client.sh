...
openssl x509 -req -in client.csr -CA /etc/openvpn/ca.crt -CAkey /etc/openvpn/ca.key -CAcreateserial -out /etc/openvpn/clients/${folder_num}/client.crt -days 3650 -extensions client -extfile /client.ext
